...
module.exports = async (ctx) => {
    ...
    ctx.state.data = {
        ...
        item: data.map(({ title, card_subtitle, rank_value, type_name, pic, cover, cover_url, uri, rating, year, release_date, good_rating_stats, null_rating_reason, tags, description, comment }) => {
            let tags_text = '',
                type_name_text = '',
                release_text = '',
